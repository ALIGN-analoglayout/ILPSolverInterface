...
find_library(cbc_lib NAMES libCbc.a)
if (NOT cbc_lib)
	...
	message(STATUS "CBC library found : ${cbc_lib}")
  find_library(osicbc_lib NAMES libOsiCbc.a)
  find_library(cbcsolver_lib NAMES libCbcSolver.a)
  find_library(cgl_lib NAMES libCgl.a)
  find_library(osiclp_lib NAMES libOsiClp.a)
  find_library(clpsolver_lib NAMES libClpSolver.a)
  find_library(clp_lib NAMES libClp.a)
  find_library(osi_lib NAMES libOsi.a)
  find_library(coinutils_lib NAMES libCoinUtils.a)
	set(cbc_LIBRARIES
	  ${osicbc_lib} ${cbcsolver_lib} ${cbc_lib} ${cgl_lib} 
    ${osiclp_lib} ${clpsolver_lib} ${clp_lib} ${osi_lib}
    ${coinutils_lib}
    )
	message(STATUS "ALL CBC libs in : ${cbc_LIBRARIES}")
	if(NOT cbc_POPULATED)
	  FetchContent_Populate(cbc)
  endif()
endif()
