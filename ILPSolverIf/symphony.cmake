...
find_library(symphony_lib NAMES libSym.a)
if (NOT symphony_lib)
if(NOT symphony_POPULATED)
  ...
  set(symphony_LIBRARIES
	...
	message(STATUS "Symphony library found : ${symphony_lib}")
  find_library(osisym_lib NAMES libOsiSym.a)
  set(symphony_LIBRARIES ${symphony_lib} ${osisym_lib})
  if(NOT symphony_POPULATED)
    FetchContent_Populate(symphony)
  endif()
	message(STATUS "ALL Symphony libs in : ${symphony_LIBRARIES}")
endif()
